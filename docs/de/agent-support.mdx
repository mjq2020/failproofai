...
dashboard](/de/dashboard), the [audit](/de/audit), and, on a connected machine, [everything the
cloud shows you](/de/cloud/sessions).
...
[Full command reference →](/de/cli/harness)
...
<Card title="failproofai policies --install" icon="terminal" href="/de/cli/install-policies">
