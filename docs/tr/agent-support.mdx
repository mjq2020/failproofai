...
dashboard](/tr/dashboard), the [audit](/tr/audit), and, on a connected machine, [everything the
cloud shows you](/tr/cloud/sessions).
...
[Full command reference →](/tr/cli/harness)
...
<Card title="failproofai policies --install" icon="terminal" href="/tr/cli/install-policies">
