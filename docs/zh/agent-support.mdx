...
dashboard](/zh/dashboard), the [audit](/zh/audit), and, on a connected machine, [everything the
cloud shows you](/zh/cloud/sessions).
...
[Full command reference →](/zh/cli/harness)
...
<Card title="failproofai policies --install" icon="terminal" href="/zh/cli/install-policies">
