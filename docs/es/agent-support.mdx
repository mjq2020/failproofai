...
dashboard](/es/dashboard), the [audit](/es/audit), and, on a connected machine, [everything the
cloud shows you](/es/cloud/sessions).
...
[Full command reference →](/es/cli/harness)
...
<Card title="failproofai policies --install" icon="terminal" href="/es/cli/install-policies">
