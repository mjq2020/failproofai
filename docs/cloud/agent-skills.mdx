...
reach for after [`failproofai audit`](/audit) shows you what your agents actually do.
...
<Card title="Acting on an audit" icon="list-check">
  Run [`failproofai audit`](/audit), and it sorts the findings into what a policy can
...
agent CLI ([`failproofai config`](/cli/config)). No cloud account, no login.
...
<Card title="Custom policies" icon="pen-to-square" href="/custom-policies">
