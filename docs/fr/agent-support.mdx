...
dashboard](/fr/dashboard), the [audit](/fr/audit), and, on a connected machine, [everything the
cloud shows you](/fr/cloud/sessions).
...
[Full command reference →](/fr/cli/harness)
...
<Card title="failproofai policies --install" icon="terminal" href="/fr/cli/install-policies">
