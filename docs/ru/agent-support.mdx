...
dashboard](/ru/dashboard), the [audit](/ru/audit), and, on a connected machine, [everything the
cloud shows you](/ru/cloud/sessions).
...
[Full command reference →](/ru/cli/harness)
...
<Card title="failproofai policies --install" icon="terminal" href="/ru/cli/install-policies">
