...
dashboard](/ar/dashboard), the [audit](/ar/audit), and, on a connected machine, [everything the
cloud shows you](/ar/cloud/sessions).
...
[Full command reference →](/ar/cli/harness)
...
<Card title="failproofai policies --install" icon="terminal" href="/ar/cli/install-policies">
