...
dashboard](/he/dashboard), the [audit](/he/audit), and, on a connected machine, [everything the
cloud shows you](/he/cloud/sessions).
...
[Full command reference →](/he/cli/harness)
...
<Card title="failproofai policies --install" icon="terminal" href="/he/cli/install-policies">
