...
dashboard](/vi/dashboard), the [audit](/vi/audit), and, on a connected machine, [everything the
cloud shows you](/vi/cloud/sessions).
...
[Full command reference →](/vi/cli/harness)
...
<Card title="failproofai policies --install" icon="terminal" href="/vi/cli/install-policies">
