...
Phần còn lại của trang này giải thích từng phần: [cài đặt](/vi/cloud/cli) riêng lẻ, [đăng nhập](/vi/cloud/cli), [cấu hình](/vi/cloud/cli), [quy ước toàn cầu](/vi/cloud/cli) mà mọi lệnh chia sẻ, và [tài liệu tham khảo lệnh đầy đủ](/vi/cloud/cli).
