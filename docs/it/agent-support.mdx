...
dashboard](/it/dashboard), the [audit](/it/audit), and, on a connected machine, [everything the
cloud shows you](/it/cloud/sessions).
...
[Full command reference →](/it/cli/harness)
...
<Card title="failproofai policies --install" icon="terminal" href="/it/cli/install-policies">
