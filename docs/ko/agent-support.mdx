...
dashboard](/ko/dashboard), the [audit](/ko/audit), and, on a connected machine, [everything the
cloud shows you](/ko/cloud/sessions).
...
[Full command reference →](/ko/cli/harness)
...
<Card title="failproofai policies --install" icon="terminal" href="/ko/cli/install-policies">
