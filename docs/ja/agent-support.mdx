...
dashboard](/ja/dashboard), the [audit](/ja/audit), and, on a connected machine, [everything the
cloud shows you](/ja/cloud/sessions).
...
[Full command reference →](/ja/cli/harness)
...
<Card title="failproofai policies --install" icon="terminal" href="/ja/cli/install-policies">
