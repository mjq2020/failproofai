...
dashboard](/hi/dashboard), the [audit](/hi/audit), and, on a connected machine, [everything the
cloud shows you](/hi/cloud/sessions).
...
[Full command reference →](/hi/cli/harness)
...
<Card title="failproofai policies --install" icon="terminal" href="/hi/cli/install-policies">
